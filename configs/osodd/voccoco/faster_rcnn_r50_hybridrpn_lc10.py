_base_ = [
    '../../_base_/datasets/osodd/voccoco.py',  # CHECK
...
lr_config = dict(
    ...
    warmup_ratio=0.001,
    step=[12, 16])  # CHECK
runner = dict(type='EpochBasedRunner', max_epochs=18)  # CHECK


##########################################################################
### RUNTIME
##########################################################################
checkpoint_config = dict(interval=6)  # CHECK

load_from = None
resume_from = None
workflow = [('train', 1)]

work_dir = 'out/osodd/voccoco/faster_rcnn_r50_hybridrpn_lc10'  # CHECK
