...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        classes=classes,
        ann_file=data_root + 'annotations2017/annotations/instances_train2017_person.json',
        img_prefix=data_root + 'images2017/train2017/',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        classes=classes,
        ann_file=osodd_data_root + 'annotations/instances_val_person.json',
        img_prefix=osodd_data_root + 'images/val/',
        pipeline=test_pipeline),
    test=dict(
        type=dataset_type,
        classes=classes,
        ann_file=osodd_data_root + 'annotations/instances_test_person.json',
